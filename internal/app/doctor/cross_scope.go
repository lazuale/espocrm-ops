...
func checkCrossScopeCompatibility(report *Report, prodEnv, devEnv domainenv.OperationEnv) {
	problems := []string{}

	for _, mismatch := range domainenv.MigrationCompatibilityMismatches(prodEnv, devEnv) {
