...
func normalizeOperationGateJSON(t *testing.T, raw []byte, fixture supportBundleFixture) []byte {
	t.Helper()
	...
	replacements := map[string]string{
		...
		filepath.Join(fixture.projectDir, "runtime", "prod", "db"):   "REPLACE_DB_STORAGE_DIR",
		filepath.Join(fixture.projectDir, "runtime", "prod", "espo"): "REPLACE_ESPO_STORAGE_DIR",
