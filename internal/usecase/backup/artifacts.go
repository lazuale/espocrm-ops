...
func allocateBackupExecutionState(req ExecuteRequest) (backupExecutionState, error) {
...
func backupTempPaths(state backupExecutionState, req ExecuteRequest) []string {
	paths := []string{
...
func createFilesBackupArchive(req ExecuteRequest, archivePath string) (filesArchiveInfo, error) {
	...
	if err := platformdocker.CreateTarArchiveViaHelper(req.StorageDir, archivePath, req.MariaDBTag, req.EspoCRMImage); err != nil {
		return filesArchiveInfo{}, executeFailure{
